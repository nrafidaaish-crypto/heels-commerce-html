...
function navigateTo(pageId, pushToHistory = true) {
  ...
  if (historyStack.length > 1 && pageId !== 'customer-home' && pageId !== 'admin-dashboard-page' && pageId !== 'welcome-page' && pageId !== 'role-selection-page') {
  ...
  switch(pageId) {
    ...
    case 'admin-profile-page':
      pageTitleEl.innerText = "Profil Admin";
      break;
  }
...
function setupLayoutForUser() {
  ...
  if (currentUser.role === 'customer') {
    ...
    nav.innerHTML = `
      ...
      <button class="nav-item" onclick="navigateTo('customer-orders-page')"><i class="fa-solid fa-receipt"></i>Pesanan</button>
    ...
    nav.innerHTML = `
      ...
      <button class="nav-item" onclick="navigateTo('admin-input-page')"><i class="fa-solid fa-plus-circle"></i>Input</button>
      ...
      <button class="nav-item" onclick="navigateTo('admin-profile-page')"><i class="fa-solid fa-user-shield"></i>Profil</button>
    `;
  }
}
